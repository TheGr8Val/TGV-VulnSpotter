...
[ES] **TGV-VulnSpotter** es una colección de desafíos de ciberseguridad práctica donde entrenas tu capacidad para detectar vulnerabilidades en fragmentos de código, configuraciones cloud, reglas de red y patrones de arquitectura de estilo real.

Sin sistema de puntuación CTF. Sin tabla de posiciones. Solo tú, el código y tu ojo para los errores.
...
Community submissions are welcome. Bring your best work.
